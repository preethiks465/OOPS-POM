...
public class BaseTest {
	...
	public void ReportStart() {
		...
		page.test = page.rep.startTest(this.getClass().getName());// Start this test
		driver.close();
	}
	...
	public void setup(String browser) {
		RunMode.add("RunMode");
		Object[][] r = (page.testutil.getdata(SheetName, CurrentTestCase, RunMode));
		String RunStatus = r[0][0].toString();
